...
class DataType:
    ...
    def getProtobufCall(self):
        if self.name == "void":
            ...
            return "add_intvalue((int)" # FIXME: Should handle long properly
        else:
...
GL3PROTOBUF_TYPE_MAP = {
    ...
    "GLint64":DataType.LONG,
    "GLuint64":DataType.LONG, # FIXME: May need to handle unsigned long differently
...
def getDataTypeFromKw(kw):
    ...
    return GL3PROTOBUF_TYPE_MAP.get(kw)
...
if __name__ == '__main__':
    ...
    apis = removeDuplicates(apis)       # remove duplication of functions common to GL1, GL2 and GL3
