...
enum GLMessage_DataType_Type {
  ...
  GLMessage_DataType_Type_LONG = 8
};
...
const GLMessage_DataType_Type GLMessage_DataType_Type_Type_MAX = GLMessage_DataType_Type_LONG;
...
class GLMessage_DataType : public ::google::protobuf::MessageLite {
 public:
  ...
  static const Type LONG = GLMessage_DataType_Type_LONG;
